...
public class StaffLoginPage {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StaffLoginPage window = new StaffLoginPage();
	...
	private void initialize() {
		...
		btnLogin.setBounds(284, 335, 102, 33);
		...
		btnSignup.setFont(new Font("Yu Gothic UI Light", Font.BOLD, 17));
		btnSignup.setBackground(new Color(0, 0, 255));
		btnSignup.setBounds(423, 335, 102, 33);
